import { useUpdateHeightMeasurement } from "@api/hooks";
...
export const HeightMeasurementEditForm = ({ measurement, onClose }: Props) => {
  ...
  const onSubmit = ({ name, color }: FormParams) => {
    updateHeightMeasurement(
      ...
      },
      {
        onSuccess: () => {
          openSnackbar({
            message: t("project.tools.height-measurement-updated-successfully"),
            severity: "success",
          });
        },
      }
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Stack direction="row" justifyContent="space-between">
          <LoadingButton
            type="submit"
            variant="contained"
            loading={isUpdateHeightMeasurementPending}
          >
